...
public class MySchedule extends Fragment
{
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot data: dataSnapshot.getChildren())
                {
                    ...
                    if (eventId.equals(Constants.CURRENT_EVENT_ID))
                    {
                        ...
                        {
                            String[] array = ds.child("subscribers").getValue(String.class).trim().split(",");
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle(getString(R.string.title_my_schedule));
    }

    public MySchedule setInfo(Event e){
        this.event = e;
        return this;
    }
