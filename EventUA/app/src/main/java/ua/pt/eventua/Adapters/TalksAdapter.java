...
public class TalksAdapter extends RecyclerView.Adapter<TalksAdapter.ViewHolder>
{
    ...
    public TalksAdapter(Context context, ArrayList<Talk> eventsData, Activity mActivity) {
    ...
    @Override
    public TalksAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        return new ViewHolder(LayoutInflater.from(mContext).inflate(R.layout.schedule_item, parent, false));
    }

    public void onBindViewHolder(TalksAdapter.ViewHolder holder, int position) {
        // Get current sport.
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener
    {
        ...
        void bindTo(Talk currentEvent){
            ...
            String convertedHours = ConvertDate.dateToString_days(currentEvent.getHours());
            convertedHours += (" - " + ConvertDate.dateToString_hours(currentEvent.getHours()));
            mInfoText.setText(convertedHours);
